    ...
    <>
      ...
      >
        ...
        <motion.div variants={item} className="hero-cta">
          <button className="btn-primary" onClick={() => setAskAIOpen(true)}>
            <FontAwesomeIcon icon={faBolt} /> Ask AI
          </button>
          <Link href="/work" className="btn-outline">
            {t("hero.ctaWork")} →
          </Link>
          <a href="/Rodriguez_Santiago_CV.pdf" className="btn-ghost" download>
            ↓ {t("hero.ctaCV")}
          </a>
        </motion.div>
        ...
        <div className="wib-inner">
          <div className="hero-testimonial-inner">
            <blockquote className="hero-testimonial-quote">
              "Don't get distracted by a young developer's age. Building digital
              products from scratch, scaling them, and finding product-market
              fit is by far the hardest job I've done. But having a team member
              like Santi makes it so much easier."
            </blockquote>
            <div className="hero-testimonial-author">
              ...
              <div>
                ...
                <p className="hero-testimonial-role mono">
                  CEO/Founder · Straico / OnTrack
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="wib-inner">
          ...
          <div className="beyond-grid">
            {[
              {
                name: "Triple Nexo",
                sector: "NGO · Full-Stack · Social Impact",
                year: "2026",
              },
              {
                name: "Together Finance",
                sector: "Finance · Azure · International",
                year: "2026",
              },
              {
                name: "EngiTool",
                sector: "Industrial · Frontend",
                year: "2025",
              },
            ].map(({ name, sector, year }) => (
              <div key={name} className="beyond-card">
                <p className="beyond-name">{name}</p>
                <p className="beyond-sector mono">
                  {sector} · {year}
                </p>
              </div>
            ))}
            ...
            <article className="rec-card">
              <div className="rec-header">
                ...
                <div>
                  ...
                  <p className="rec-role mono">
                    CEO/Founder · Straico / OnTrack
                  </p>
                  <p className="rec-context">
                    AI product development and platform engineering.
                  </p>
                </div>
              </div>
              <blockquote className="rec-quote">
                Don't get distracted by a young developer's age. Building
                digital products from scratch, scaling them, and finding
                product-market fit is by far the hardest job I've done. But
                having a team member like Santi makes it so much easier. He's
                one of the best developers I've known — not just for his
                technical skills, but for his personality, discipline, and
                enthusiasm.
              </blockquote>
            </article>
          </div>
